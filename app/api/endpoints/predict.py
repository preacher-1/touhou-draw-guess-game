...
# --- API 端点 ---
@router.post("/predict/top1", response_model=PredictionResponse, summary="Get Top-1 Prediction")
...
@router.post("/predict/top5", response_model=PredictionResponse, summary="Get Top-5 Predictions")
